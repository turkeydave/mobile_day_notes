// make this real constructor object for 'service' consistency
...
DataService.prototype.listUsers = function(callback){
...
DataService.prototype.listNotesForUser = function(usersName, callback){
...
DataService.prototype.addNote = function(newNote, callback){
    $.ajax({
        url: '/api/addNote',
        data: newNote,
        cache: false,
...
DataService.prototype.nukeNote = function(id, callback){
    $.ajax({
        url: '/api/nukeNote/' + id,
        //data: JSON.stringify({}),
        cache: false,
